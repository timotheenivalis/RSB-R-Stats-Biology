...
\hlkwd{library}\hlstd{(ggplot2)}
  \hlkwd{ggplot}\hlstd{( iris[iris}\hlopt{$}\hlstd{Species} \hlopt{%in%} \hlkwd{c}\hlstd{(}\hlstr{"setosa"}\hlstd{,}\hlstr{"versicolor"}\hlstd{),],}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in is.data.frame(data): object 'Ans' not found}}\begin{alltt}
 \hlstd{lm2} \hlkwb{<-} \hlkwd{lm}\hlstd{(y} \hlopt{~} \hlstd{x ,} \hlkwc{data}\hlstd{=Ans[Ans}\hlopt{$}\hlstd{distri}\hlopt{==}\hlnum{2}\hlstd{,])}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in is.data.frame(data): object 'Ans' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in predict(lm2, se.fit = TRUE, interval = "{}confidence"{}): object 'lm2' not found}}\begin{alltt}
\hlstd{pred2} \hlkwb{<-} \hlkwd{cbind}\hlstd{(Ans[Ans}\hlopt{$}\hlstd{distri}\hlopt{==}\hlnum{2}\hlstd{,], pred2)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error in cbind(Ans[Ans\$distri == 2, ], pred2): object 'Ans' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in plot(pred2\$x, pred2\$y, ylim = c(0, 12), col = "{}red"{}, pch = 16, : object 'pred2' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in lines(pred2\$x, pred2\$fit.fit): object 'pred2' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in arrows(x0 = pred2\$x, y0 = pred2\$fit.lwr, y1 = pred2\$fit.upr, : object 'pred2' not found}}
